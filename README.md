...
## 🆚 Cortex vs Google Notebook LM

| Feature | Cortex | Google Notebook LM | Advantage |
|---------|---------------|--------------------|-----------|
...
### Getting Started
- **[📖 Introduction](docs/0-START-HERE/index.md)** - Learn what Cortex offers
...
- **[🧭 Vision & Principles](VISION.md)** - What Cortex is, and where it's going
...
## 📖 Need Help?
- **🤖 AI Installation Assistant**: We have a [CustomGPT built to help you install Cortex](https://chatgpt.com/g/g-68776e2765b48191bd1bae3f30212631-open-notebook-installation-assistant) - it will guide you through each step!
- **New to Cortex?** Start with our [Getting Started Guide](docs/0-START-HERE/index.md)
...
- ⭐ **Star this repo** - Show your support and help others discover Cortex

### Contributing
We welcome contributions! We're especially looking for help with:
- **Frontend Development**: Help improve our modern Next.js/React UI
- **Testing & Bug Fixes**: Make Cortex more robust
...
Cortex is MIT licensed. See the [LICENSE](LICENSE) file for details.
