...
export const zhTW = {
  ...
  models: {
    ...
    defaultAssignmentsDesc: "設定用於 Cortex 不同用途的預設模型",
    missingRequiredModels: "缺少必需的模型：{{models}}。如果没有這些模型，Cortex 可能無法正常運行。",
  ...
  apiKeys: {
    ...
    description: "將 API 金鑰安全地儲存在資料庫中，以在 Cortex 中啟用 AI 服務商。",
