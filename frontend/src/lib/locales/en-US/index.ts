export const enUS = {
  ...
  connectionErrors: {
    ...
    apiDesc: "The Cortex API server could not be reached",
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow Cortex to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of Cortex is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across Cortex",
    missingRequiredModels: "Missing required models: {{models}}. Cortex may not function properly without these.",
  ...
  apiKeys: {
    ...
    description: "Store API keys securely in the database to enable AI providers in Cortex.",
