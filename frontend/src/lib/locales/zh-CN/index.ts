...
export const zhCN = {
  ...
  advanced: {
    ...
    updateAvailableDesc: "Cortex 的新版本可用。",
    upToDate: "已是最新",
    unknown: "未知",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "配置用于 Cortex 不同用途的默认模型",
    missingRequiredModels: "缺少必需的模型：{{models}}。如果没有这些模型，Cortex 可能无法正常运行。",
  ...
  apiKeys: {
    ...
    description: "将 API 密钥安全地存储在数据库中，以在 Cortex 中启用 AI 服务商。",
