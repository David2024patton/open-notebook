...
export const frFR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Le serveur API de Cortex est injoignable",
    ...
    docLink: "Documentation de Cortex",
  ...
  notFoundDescription: "This source may have been deleted.",
  ...
  settings: {
    ...
    filesHelp: "Une fois vos fichiers téléchargés et traités, ils ne sont plus nécessaires. La plupart des utilisateurs devraient autoriser Cortex à supprimer automatiquement les fichiers du dossier de téléchargement.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Une nouvelle version de Cortex est disponible.",
    upToDate: "À jour",
    unknown: "Inconnu",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configurez quels modèles utiliser pour les différents usages d'Cortex",
    missingRequiredModels: "Modèles requis manquants : {{models}}. Cortex pourrait ne pas fonctionner correctement sans eux.",
  ...
  apiKeys: {
    ...
    description: "Stockez les clés API de manière sécurisée dans la base de données pour activer les fournisseurs d'IA dans Cortex.",
