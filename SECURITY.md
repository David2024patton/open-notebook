...
Cortex is an actively developed project. Security fixes are applied to the
...
- Steps to reproduce (a proof of concept, affected endpoint/component, or sample
  configuration).
- The Cortex version and how you are running it (Docker Compose,
...
Cortex is **self-hosted**: you run the API, frontend, and SurrealDB
